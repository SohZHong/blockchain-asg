...
contract MarketplaceTest is Test {
    ...
    function testWithdrawFees() public {
        ...
        assertEq(marketplace.owner().balance, initialOwnerBalance + marketplaceBalance);
    }
    ...
    function test_RevertWhen_UpdatingFeeByNonOwner() public {
        vm.prank(RANDOM_USER);
        vm.expectRevert(abi.encodeWithSignature("OwnableUnauthorizedAccount(address)", RANDOM_USER));
